...
const presets = {
  '01': {
    name: 'Preset 01 (Refined Balance)',
    colors: {
      // Refined version with normalized endpoints and peak positions
      // Two-tier lightness system: Neutral/cool anchors (0.15) + Dramatic cools (0.078-0.084) + Warm progression (0.20-0.25)
      // Peak positions normalized to 0.36-0.38 range for consistency
      ...
      pink: { h: 337.1, l: 0.52, c: 0.219, lightnessCurve: { start: 0.97, end: 0.084, type: 'linear' }, chromaCurve: { start: 0.021, peak: 0.219, end: 0.019, peakPosition: 0.38 } },
      purple: { h: 312.8, l: 0.53, c: 0.221, lightnessCurve: { start: 0.98, end: 0.082, type: 'linear' }, chromaCurve: { start: 0.013, peak: 0.221, end: 0.020, peakPosition: 0.38 } },
      violet: { h: 291.0, l: 0.53, c: 0.226, lightnessCurve: { start: 0.979, end: 0.078, type: 'linear' }, chromaCurve: { start: 0.011, peak: 0.226, end: 0.018, peakPosition: 0.38 } },
      blue: { h: 275.2, l: 0.53, c: 0.258, lightnessCurve: { start: 0.971, end: 0.084, type: 'linear' }, chromaCurve: { start: 0.014, peak: 0.258, end: 0.012, peakPosition: 0.38 } },
  ...
  '08': {
    name: 'Preset 08 (User Tuned)',
    colors: {
      // User's original preferred balanced colors with custom yellow hue ramping
      cyan: { h: 207.3, l: 0.50, c: 0.121, lightnessCurve: { start: 0.98, end: 0.15, type: 'linear' }, chromaCurve: { start: 0.017, peak: 0.121, end: 0.025, peakPosition: 0.35 } },
      green: { h: 140.0, l: 0.50, c: 0.228, lightnessCurve: { start: 0.98, end: 0.15, type: 'linear' }, chromaCurve: { start: 0.031, peak: 0.228, end: 0.040, peakPosition: 0.35 } },
      yellow: {
        h: 80.0, l: 0.66, c: 0.169,
